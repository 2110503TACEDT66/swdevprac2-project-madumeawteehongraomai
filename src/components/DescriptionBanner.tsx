...
export default function DescriptionBanner() {
    return (
        <div className="h-[100%] w-[50%] flex flex-col">
            <div className="w-[95%] h-[65%] ml-[2%] mt-[6%] p-5 bg-gray-300 font-bold justify-center flex items-center rounded-lg shadow-lg -lg text-2xl font-roboto text-center">
                This web is made for people who don't have a job. This is a chance for you to be HIRES
